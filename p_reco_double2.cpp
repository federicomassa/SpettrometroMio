...
void p_reco() {
  ...
  TFile* root_out = new TFile("../Spettrometro_Files/measures_final_double2.root", "recreate");
  ...
  nt_final =  MergeNtuples(nt_gen, nt_iter, "measures_final_double2", "Complete Ntuple");
