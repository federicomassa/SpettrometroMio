...
void p_reco() {
  ...
  const char* nt_iter_list = "chi2:z_reco:p_plus_reco:p_min_reco:x1_plus_r:y1_plus_r:x2_plus_r:y2_plus_r:x3_plus_r:y3_plus_r:x4_plus_r:y4_plus_r:x1_min_r:y1_min_r:x2_min_r:y2_min_r:x3_min_r:y3_min_r:x4_min_r:y4_min_r";

  TFile* root_in = new TFile("../Spettrometro_Files/measures.root");
  TFile* root_out = new TFile("../Spettrometro_Files/measures_final.root", "recreate");
  ...
  Double_t chi2;
  Double_t* args_iter = new Double_t[20];
