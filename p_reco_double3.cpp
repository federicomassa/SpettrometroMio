...
void p_reco() {
  ...
  TFile* root_out = new TFile("../Spettrometro_Files/measures_final_double3.root", "recreate");
  ...
  // for (UInt_t i = 0; i < 3000; i++) {
    ...
    iter->Initialize(16,14,3,init_meas,init_pars,Constr, Der, PDer, err);
  ...
  nt_final =  MergeNtuples(nt_gen, nt_iter, "measures_final_double3", "Complete Ntuple");
