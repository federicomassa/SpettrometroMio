...
double P1_plus[3], P2_plus[3], P1_min[3], P2_min[3];
  ...
  double CDA_plus() {
    double r;
    r = P1_plus[2] - (P2_plus[2] - P1_plus[2])*(P1_plus[0]*(P2_plus[0]-P1_plus[0]) + P1_plus[1]*(P2_plus[1]-P1_plus[1]))/((P2_plus[0] - P1_plus[0])*(P2_plus[0] - P1_plus[0]) + (P2_plus[1] - P1_plus[1])*(P2_plus[1] - P1_plus[1]));
    ...
    double CDA_min() {
    double r;
    r = P1_min[2] - (P2_min[2] - P1_min[2])*(P1_min[0]*(P2_min[0]-P1_min[0]) + P1_min[1]*(P2_min[1]-P1_min[1]))/((P2_min[0] - P1_min[0])*(P2_min[0] - P1_min[0]) + (P2_min[1] - P1_min[1])*(P2_min[1] - P1_min[1]));
