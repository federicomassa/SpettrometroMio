...
#ifndef CONSTR_DOUBLE4_H
#define CONSTR_DOUBLE4_H
...
TMatrixD Der(Double_t* var, Double_t* par) {
  ...
  B(0,12) = -1/(par[1]*par[1])*2*TMath::Power(z2-z1,2)*Delta_x_plus(var)/TMath::Power(Norm_plus(var),4) + 1/(par[1]*par[2])*TMath::Power(z2-z1,2)*Delta_x_plus(var)/Norm_min(var)/TMath::Power(Norm_plus(var),3);
  B(1,12) = -1/(par[1]*par[1])*2*TMath::Power(z2-z1,2)*Delta_y_plus(var)/TMath::Power(Norm_plus(var),4) + 1/(par[1]*par[2])*TMath::Power(z2-z1,2)*Delta_y_plus(var)/Norm_min(var)/TMath::Power(Norm_plus(var),3);
  B(2,12) = -B(0,12);
  B(3,12) = -B(1,12);
  B(8,12) = 1/(par[1]*par[2])*TMath::Power(z2-z1,2)*Delta_x_min(var)/Norm_plus(var)/TMath::Power(Norm_min(var),3);
  B(9,12) = 1/(par[1]*par[2])*TMath::Power(z2-z1,2)*Delta_y_min(var)/Norm_plus(var)/TMath::Power(Norm_min(var),3);
  B(10,12) = -B(8,12);
  B(11,12) = -B(9,12);
...
TMatrixD PDer(Double_t* var, Double_t* par) {
  ...
  A(1,12) = -Energy_min(par)/Energy_plus(par)*TMath::Power(1/par[1],3) - 2*TMath::Power(1/par[1],3)*(TMath::Power(Norm_plus(var),2)-TMath::Power(z2-z1,2))-TMath::Power(1/par[1],2)/par[2]*TMath::Power(z2-z1,2)/Norm_plus(var)/Norm_min(var);

  A(2,10) = -0.5*B_event_approx::p_kick*(z3-z2);
  A(2,11) = -B_event_approx::p_kick;
  A(2,12) = -Energy_plus(par)/Energy_min(par)*TMath::Power(1/par[2],3) - TMath::Power(1/par[2],2)/par[1]*TMath::Power(z2-z1,2)/Norm_plus(var)/Norm_min(var);
